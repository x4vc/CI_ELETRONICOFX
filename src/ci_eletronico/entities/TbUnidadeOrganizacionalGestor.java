...
public class TbUnidadeOrganizacionalGestor implements Serializable {
    ...
    public TbUnidadeOrganizacionalGestor(Integer idUoge, int idUoGestor, boolean uogeAtivo) {
        this.idUoge = idUoge;
    ...
    public String toString() {
        return "ci_eletronico.entities.TbUnidadeOrganizacionalGestor[ idUoge=" + idUoge + " ]";
    }
